...
Number *Integer::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
	    ...
	    temp->set_val(temp->val() + this->val());
	    delete (this);
	    return temp;
	    ...
	    temp->set_val(temp->real() + this->val(), temp->imag());
	    delete (this);
	    return temp;
...
Number *Integer::sub(Number * num) {
	...
	if (num->types() == INTEGER) {
            Integer* temp = dynamic_cast<Integer*>(num);
	    temp->set_val(this->val() - temp->val());
	    delete (this);
	    return temp;
	    ...
	    Complex* temp = dynamic_cast<Complex*>(num);
	    temp->set_val(this->val() - temp->real(), temp->imag());
	    delete (this);
	    return temp;
...
Number *Integer::mul(Number * num) {
	...
	if (num->types() == INTEGER) {
	    ...
	    Complex* temp = dynamic_cast<Complex*>(num);
	    temp->set_val(temp->real() * this->val(), temp->imag() * this->val());
	    delete (this);
	    return temp;
